...
import { Lead, Note, Task, Comment, Relationship } from './models';
...
export class LeadDetailComponent implements OnInit {
  ...
  ngOnInit() {
    this.lead = {
      ...
      csr: { name: 'Handyman', initials: 'HM', avatarUrl: 'https://i.pravatar.cc/30?u=handyman' },
    ...
    this.relationships = [
      { id: 'r1', name: 'Mary Thompson', avatarUrl: 'https://i.pravatar.cc/100?u=mary', leadId: '14315415', type: 'Prospect', relationship: 'Cousnin' },
      { id: 'r2', name: 'Quinn Evans', avatarUrl: 'https://i.pravatar.cc/100?u=quinn', leadId: '13213344', type: 'Prospect', relationship: 'Husband' },
      { id: 'r3', name: 'Sam Wright', avatarUrl: 'https://i.pravatar.cc/100?u=sam', leadId: '15454166', type: 'Prospect', relationship: 'Brother' }
    ];
  }
}
